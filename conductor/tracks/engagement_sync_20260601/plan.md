...
- [ ] Task: Create `tests/test_engagement_sync.py` with batch mocks (YouTube/Supabase)
- [ ] Task: Implement `get_youtube_stats_batch(video_ids)` in `publisher.py`
- [ ] Task: Implement `sync_engagement_stats(db_client)` with batching logic
