...
- [ ] Task: Implement the 'Social Dynamic' section in the prompt with disagreement rules
- [ ] Task: Update Alistair persona logic to scale crisis based on news confidence
- [ ] Task: Conductor - User Manual Verification 'Phase 2' (Protocol in workflow.md)

## Phase 3: Semantic Refresh & Variety (Creative)
- [ ] Task: Create validation tests for forbidden tropes and title variety
- [ ] Task: Implement the 'Banned Metaphor List' and enforce title structure uniqueness
